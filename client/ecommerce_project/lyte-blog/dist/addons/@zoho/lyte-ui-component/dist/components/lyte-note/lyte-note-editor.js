...
_template:"<template tag-name=\"lyte-note-editor\"> <div class=\"lyteNoteFakeElement {{if(draftMode,'lyteNoteDraft','')}}\" onclick=\"{{action('renderEditor',this)}}\"> <template is=\"if\" value=\"{{draftMode}}\"><template case=\"true\"> <div class=\"lyteNoteDraftWrapper\"> {{unescape(draftText,undefined,sanitizer.attr)}} </div> </template><template case=\"false\"> <div class=\"lyteNotePlaceholder\"> {{expHandlers(ltPropTextEditor.placeholder,'||',\"\")}} </div> </template></template> </div> <template is=\"if\" value=\"{{render}}\"><template case=\"true\"> <div class=\"lyteNoteEditorWrapper\" style=\"{{lyteNoteStyle(ltPropBackground,ltPropBorder)}}\"> <div class=\"lyteNoteTextEditorWrapper\"> <lyte-texteditor lt-prop=\"{{stringify(ltPropTextEditor)}}\" class=\"lyteNoteMainEditor\" on-trigger=\"{{method('trigger')}}\" on-focus=\"{{method('focus')}}\" on-blur=\"{{method('blur')}}\" on-paste=\"{{method('paste')}}\" id=\"{{randomId}}\" show-placeholder=\"{{lbind(isEmpty)}}\" on-select=\"{{method('selection')}}\"></lyte-texteditor> <div lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-title=\"{{ltPropText.noteBackground}}\" lt-prop-tooltip-class=\"lyteNoteTooltip\" class=\"lyteNoteBgSwitcher\" onclick=\"{{action('common_action','bg_switch')}}\"></div> </div> <template is=\"if\" value=\"{{ltPropVoiceNote}}\"><template case=\"true\"> <lyte-voicenote class=\"lyteNotePreviewVoiceNote\" id=\"{{ltPropVoiceNote.id}}\" lt-prop-src=\"{{ltPropVoiceNote.src}}\"></lyte-voicenote> </template></template> <div class=\"lyteNoteFileStatus {{showElement}}\"> <lyte-fileupload lt-prop=\"{{stringify(ltPropFileUpload)}}\" lt-prop-yield=\"true\" on-before-send=\"{{method('beforeSend')}}\" on-success=\"{{method('success')}}\" on-failure=\"{{method('failure')}}\" predefined-list=\"{{ltPropAttachments}}\" on-remove=\"{{method('removeFile')}}\" on-before-remove=\"{{method('beforeRemove')}}\" on-add=\"{{method('addFile')}}\"> <template is=\"registerYield\" yield-name=\"file\"> <lyte-file-select-area></lyte-file-select-area> <div class=\"lyteFileUpdList\"> <template is=\"for\" items=\"{{predefinedList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile\"> <div class=\"lyteNoteFileUpdListInnerWrap\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text lt-prop-tooltip-class=\"lyteCommentFileNameTooltip\" class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,\"\",1)}} )</span> </div> <lyte-file-close data-value=\"{{item.id}}\" class=\"{{item.status}}\"></lyte-file-close> </div> </template> <template is=\"for\" items=\"{{queueList}}\" item=\"item\" index=\"index\"> <div class=\"lyteFileUpdListFile {{item.status}}\"> <div class=\"lyteNoteFileUpdListInnerWrap\"> <div class=\"lyteFileUpdTypePreview\"> <template is=\"if\" value=\"{{lyteUiImageFile(item)}}\"><template case=\"true\"> <img class=\"lyteFileUpdThumb\" src=\"{{item.src}}\"> </template><template case=\"false\"> <span class=\"lyteFileUpdTypeIcon {{item.fileType}}\"></span> </template></template> </div> <lyte-text lt-prop-tooltip-class=\"lyteCommentFileNameTooltip\" class=\"lyteFileUpdFileName\" lt-prop-value=\"{{item.name}}\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\"></lyte-text> <span class=\"lyteFileUpdFileSize\">( {{lyteUiFileSize(item.size,\"\",1)}} )</span> </div> <template is=\"if\" value=\"{{expHandlers(item.percentage,'!=',undefined)}}\"><template case=\"true\"> <div class=\"lyteFileUpdFileStatus\" data-completed=\"{{item.percentage}}\"> <div class=\"lyteFileUpdProgressBar {{item.status}}\"> <div class=\"lyteFileUpdProgressFill\" style=\"width: {{item.percentage}}%\"></div> </div> </div> </template></template><template is=\"if\" value=\"{{expHandlers(item.status,'==',&quot;error&quot;)}}\"><template case=\"true\"> <lyte-file-retry data-value=\"{{item.id}}\"> <span class=\"lyteFileUpdFailMsg\">{{ltPropText.failureMessage}}</span> <span class=\"lyteFileUpdRetryMsg\">{{ltPropText.retryText}}</span> </lyte-file-retry> </template></template> <template is=\"if\" value=\"{{expHandlers(expHandlers(item.status,'==',&quot;error&quot;),'||',expHandlers(item.status,'==',&quot;success&quot;))}}\"><template case=\"true\"> <lyte-file-close data-value=\"{{item.id}}\" class=\"{{item.status}}\"></lyte-file-close> </template><template case=\"false\"> <span class=\"lyteNoteIndividualFilePercentage\">{{item.percentage}}</span> </template></template> </div> </template> </div> </template> </lyte-fileupload> <template is=\"if\" value=\"{{showStatus}}\"><template case=\"true\"> <div class=\"lyteNoteFileUploadStatus {{showElement}}\"> <div class=\"lyteNoteUploadCountSection\"> <span class=\"lyteNoteSvgContainer\"> <svg viewBox=\"0 0 100 100\" width=\"100%\" height=\"100%\"> <g class=\"lyteNoteSvgGroup\"> <circle cx=\"50\" cy=\"50\" r=\"40\" class=\"background_circle\" stroke-dasharray=\"314.16\"></circle> <circle cx=\"50\" cy=\"50\" r=\"40\" class=\"progress_circle\" stroke-dasharray=\"314.16\" stroke-dashoffset=\"{{dashoffset}}\"></circle> </g> </svg> </span> <span class=\"lyteNoteUploadText\">{{ltPropText.fileUpload}} :</span> <span class=\"lyteNoteUploadCount\"> <span class=\"lyteNoteUploadCountNumber\">{{uploadedCount}}</span> / <span class=\"lyteNoteTotalCount\">{{totalCount}}</span> </span> <span class=\"lyteNoteFileLimitMessage\">{{ltPropText.limit}}</span> </div> <template is=\"if\" value=\"{{ltPropFileUpload.totalFilesSize}}\"><template case=\"true\"> <div class=\"lyteNoteUploadSize\"> <span class=\"lyteNoteSvgContainer\"> <svg viewBox=\"0 0 100 100\" width=\"100%\" height=\"100%\"> <g class=\"lyteNoteSvgGroup\"> <circle cx=\"50\" cy=\"50\" r=\"20\" class=\"background_circle\" stroke-dasharray=\"125.66\"></circle> <circle cx=\"50\" cy=\"50\" r=\"20\" class=\"progress_circle\" stroke-dasharray=\"125.66\" stroke-dashoffset=\"{{dashoffsetStorage}}\"></circle> </g> </svg> </span> <span class=\"lyteNoteSizeText\">{{ltPropText.storage}} :</span> <span class=\"lyteNoteSizeValue\"> <span class=\"lyteNoteUploadSizeNumber\">{{uploadedSize}}</span> / <span class=\"lyteNoteTotalSiza\">{{totalSize}}</span> </span> </div> </template></template> </div> </template></template> </div> <div class=\"lyteNoteEditorFooter\"> <div class=\"lyteNoteFooterActions\"> <div lt-prop-tooltip-class=\"lyteNoteTooltip\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-title=\"{{ltPropText.attachFiles}}\" class=\"lyteNoteFileUpload\" onclick=\"{{action('trigger_upload',event)}}\"></div> <span lt-prop-tooltip-class=\"lyteNoteTooltip\" lt-prop-tooltip-config=\"{{ltPropTooltipConfig}}\" lt-prop-title=\"{{ltPropText.smileyIcon}}\" class=\"lyteNoteSmileyIcon\" onclick=\"{{action('common_action','show_smiley')}}\"></span> <div class=\"lyteNoteIconHolder\"> <span class=\"lyteNoteEditorIcon lyteEditorPanelHidden\" onclick=\"{{action('toggle_icon',this)}}\"></span> <lyte-editorpanel class=\"lyteEditorHide lyteNoteEditorPanel{{ltPropEditorAnimation}}\" lt-prop=\"{{stringify(ltPropEditorPanel)}}\" lt-prop-editor=\"#{{randomId}}\"></lyte-editorpanel> </div> </div> <div class=\"{{lyteUiAddShowClass(disabled,'lyteNoteCancelSaveWrap','lyteNoteButtonDisabled')}}\"> <template is=\"for\" items=\"{{ltPropButtons}}\" item=\"item\" index=\"index\"> <lyte-button class=\"{{item.class}}\" lt-prop=\"{{stringify(item.properties)}}\" lt-prop-disabled=\"{{item.properties.disabled}}\" onclick=\"{{action('common_action',item.method)}}\"> <template is=\"registerYield\" yield-name=\"text\"> {{item.text}} </template> </lyte-button> </template> </div> </div> </div> </template></template> </template>",
_dynamicNodes : [{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"if","position":[1,1],"cases":{"true":{"dynamicNodes":[{"type":"text","position":[1,1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,1]}]}},"default":{}},{"type":"attr","position":[3]},{"type":"if","position":[3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1],"attr":{"style":{"name":"style","helperInfo":{"name":"lyteNoteStyle","args":["ltPropBackground","ltPropBorder"]}}}},{"type":"attr","position":[1,1,1]},{"type":"componentDynamic","position":[1,1,1]},{"type":"attr","position":[1,1,3]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,5]},{"type":"attr","position":[1,5,1]},{"type":"registerYield","position":[1,5,1,1],"dynamicNodes":[{"type":"componentDynamic","position":[1]},{"type":"attr","position":[3,1]},{"type":"for","position":[3,1],"dynamicNodes":[{"type":"attr","position":[1,1,1,1]},{"type":"if","position":[1,1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,1,3]},{"type":"componentDynamic","position":[1,1,3]},{"type":"text","position":[1,1,5,1]},{"type":"attr","position":[1,3]},{"type":"componentDynamic","position":[1,3]}]},{"type":"attr","position":[3,3]},{"type":"for","position":[3,3],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1,1]},{"type":"if","position":[1,1,1,1],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]}]},"false":{"dynamicNodes":[{"type":"attr","position":[1]}]}},"default":{}},{"type":"attr","position":[1,1,3]},{"type":"componentDynamic","position":[1,1,3]},{"type":"text","position":[1,1,5,1]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1]},{"type":"attr","position":[1,1,1],"attr":{"style":{"name":"style","helperInfo":{"name":"concat","args":["'width: '","item.percentage","'%'"]}}}}]}},"default":{}},{"type":"attr","position":[1,4]},{"type":"if","position":[1,4],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"text","position":[1,1,0]},{"type":"text","position":[1,3,0]},{"type":"componentDynamic","position":[1]}]}},"default":{}},{"type":"attr","position":[1,6]},{"type":"if","position":[1,6],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"componentDynamic","position":[1]}]},"false":{"dynamicNodes":[{"type":"text","position":[1,0]}]}},"default":{}}]}]},{"type":"componentDynamic","position":[1,5,1]},{"type":"attr","position":[1,5,3]},{"type":"if","position":[1,5,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1]},{"type":"attr","position":[1,1,1,1,1,3]},{"type":"text","position":[1,1,3,0]},{"type":"text","position":[1,1,5,1,0]},{"type":"text","position":[1,1,5,3,0]},{"type":"text","position":[1,1,7,0]},{"type":"attr","position":[1,3]},{"type":"if","position":[1,3],"cases":{"true":{"dynamicNodes":[{"type":"attr","position":[1,1,1,1,3]},{"type":"text","position":[1,3,0]},{"type":"text","position":[1,5,1,0]},{"type":"text","position":[1,5,3,0]}]}},"default":{}}]}},"default":{}},{"type":"attr","position":[1,7,1,1]},{"type":"attr","position":[1,7,1,3]},{"type":"attr","position":[1,7,1,5,1]},{"type":"attr","position":[1,7,1,5,3]},{"type":"componentDynamic","position":[1,7,1,5,3]},{"type":"attr","position":[1,7,3]},{"type":"attr","position":[1,7,3,1]},{"type":"for","position":[1,7,3,1],"dynamicNodes":[{"type":"attr","position":[1]},{"type":"registerYield","position":[1,1],"dynamicNodes":[{"type":"text","position":[1]}]},{"type":"componentDynamic","position":[1]}]}]}},"default":{}}],
_observedAttributes :["ltPropEditMode","ltPropValue","ltPropButtons","ltPropTextEditor","ltPropBackground","ltPropBorder","ltPropEditorPanel","ltPropFileUpload","ltPropAttachments","ltPropEditorAnimation","ltPropResize","ltPropTooltipConfig","ltPropText","ltPropVoiceNote","render","randomId","uploadedWidth","showStatus","uploadedCount","totalCount","uploadedSize","totalSize","dashoffset","dashoffsetStorage","showElement","disabled","sanitizer","animationHeight","isEmpty","fromMain","draftMode","draftText"],
